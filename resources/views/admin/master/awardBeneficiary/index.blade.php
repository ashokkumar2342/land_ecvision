...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>Award Beneficiary Detail</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 form-group">
                    ...
                    <span class="fa fa-asterisk"></span>
                    <select name="award_detail" class="form-control select2" id="award_detail_select_box" data-table-new-without-pagination="ajax_data_table" onchange="callAjax(this,'{{ route('admin.master.award.beneficiary.table') }}','result_table')" required>
